    ...
    <div class="container py-1">
        ...
        <div class="collapse navbar-collapse" id="mainNav">
            <ul class="navbar-nav ms-auto gap-lg-2">
                ...
                <li class="nav-item">
                    <a class="nav-link <?= $currentPage === 'departments.php' ? 'active' : '' ?>" href="departments.php">Departments</a>
                </li>
            </ul>

            <a href="departments.php" class="btn btn-sm btn-accent ms-lg-3 mt-3 mt-lg-0">
                Apply Now
            </a>
        </div>
    </div>
